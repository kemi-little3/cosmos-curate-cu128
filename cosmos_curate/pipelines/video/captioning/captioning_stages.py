...
class _T5Stage(CuratorStage):
    ...
    def __init__(
        ...
        *,
        ...
        variant_by_name = {
            "fp32": t5_encoder.ModelVariant.T5_XXL,
            "fp16": t5_encoder.ModelVariant.T5_XXL_16_BIT,
        }
        self._model = t5_encoder.T5Encoder(variant_by_name[model_variant])
        self._batch_size = batch_size or (16 if operation_context.is_running_on_the_cloud() else 4)
