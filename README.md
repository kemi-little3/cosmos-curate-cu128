> **Fork notice**: this is a personal fork of [nvidia-cosmos/cosmos-curate](https://github.com/nvidia-cosmos/cosmos-curate)
> at commit `29f1358`, with China-network adjustments and personal pipeline tweaks.
> See [NOTICE-FORK.md](./NOTICE-FORK.md) for the list of modifications.
> The original upstream README follows.
>
> Clone with submodules:
>
>     git clone --recursive git@github.com:YOUR_GITHUB_USER/YOUR_REPO_NAME.git
